    # -*- coding: utf-8 -*-
"""
Created on Sun Mar 28 10:37:32 2021
...
params = {}
params['path'] = 'D:/数据集/paderborn-train/testdatashuffle_1_N15_M07_F04.csv'
params['opath'] = 'D:/数据集/paderborn-train/final1.csv'
...
try:
    ...
    label_columns = ['label']
    full_columns =columns_list+ label_columns
    i = 0
    def featureget(df_line,i):
        ...
        freq_fftline = fftpack.fftfreq(len(df_line.tolist()),1/25600)
    ...
    df_normal1 = pd.read_csv(params['path'])
    ...
    #对整合后数据每个传感器采集的波形循环提取特征
        ...
        feature_line.extend(featureget(df_normal.iloc[i],i))
        feature_line.append(df_normal1['label'][i])
